...
<p align="center">
    <img alt="act_elect" src="https://github.com/olivervillalobos/SProgramables/blob/main/images/act_elect.png?raw=true">
</p>
...
**El proposito del microcontrolador  es la programacion del circuito(intrucciones programadas).**
...
* Tambien cuenta con un ventilador para enfriar el motor.
* Sensor de temperatura: Para saber a que temperatura el plastico derretido es necesario para el proceso de impresion.
* Extrusor: Aqui se introduce el filamento de plastico para que posteriormente se empiece a derretir.
* Actuador Electrico Paso a Paso: controlar el movimiento de la impresora en los tres ejes.
